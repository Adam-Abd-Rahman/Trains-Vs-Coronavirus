...
namespace Cinemachine
{
    ...
    public class Distancechecker4 : MonoBehaviour
    {
        ...
        CinemachineDollyCart4 cinemachinedollycart4;
        ...
        void Start()
        {
            cinemachinedollycart4 = GetComponent<CinemachineDollyCart4>();
        ...
        private void Update()
        {
            ...
            if (cinemachinedollycart4.m_Position > 74.3f && cinemachinedollycart4.m_Position < 75.1f)
            {
                ScoreByDistance.SetScoreText(plusscore);
            }

            if (cinemachinedollycart4.m_Position == 75.2f)
            {
